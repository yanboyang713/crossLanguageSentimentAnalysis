...
for row in range(1, 46181):
    ...
    value = ws.cell(row=row, column=33).value
    if ranking == 10:
...
drawBoxPlots("Baidu English sentiment analysis(base on Yandex Translated data)", data_to_plot, ax)
# Save the figure
fig.savefig("BaiduEnglishSentimentAnalysis(baseOnYandexTranslatedData).png", 
bbox_inches='tight')
