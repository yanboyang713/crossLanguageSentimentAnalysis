...
drawBoxPlots("Baidu English sentiment analysis Google score standard (base on Yandex Translated data)", data_to_plot, ax)
# Save the figure
fig.savefig("BaiduEnglishSentimentAnalysisGoogleStandard(baseOnYandexTranslatedData).png", 
bbox_inches='tight')
