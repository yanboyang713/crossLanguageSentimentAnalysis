...
for row in range(1, 46181):
    ...
    value = ws.cell(row=row, column=38).value
    if ranking == 10:
...
drawBoxPlots("Baidu English sentiment analysis Google score standard (base on Baidu Translated data)", data_to_plot, ax)
# Save the figure
fig.savefig("BaiduEnglishSentimentAnalysisGoogleStandard(baseOnBaiduTranslatedData).png", bbox_inches='tight')
