...
for row in range(1, 46181):
    ...
    value = ws.cell(row=row, column=32).value
    if ranking == 10:
...
drawBoxPlots("Baidu English sentiment analysis Google score standard (base on Google Translate data)", data_to_plot, ax)
# Save the figure
fig.savefig("BaiduEnglishSentimentAnalysisGoogleStandard(baseOnGoogleTranslateData).png", bbox_inches='tight')
