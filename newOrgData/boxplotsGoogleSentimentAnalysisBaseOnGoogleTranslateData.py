...
drawBoxPlots("Google English sentiment analysis(base on Google Translate data)", data_to_plot, ax)
# Save the figure
fig.savefig("googleEnglishSentimentAnalysis(baseOnGoogleTranslateData).png", bbox_inches='tight')
