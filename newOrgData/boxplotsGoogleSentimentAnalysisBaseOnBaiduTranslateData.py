...
for row in range(1, 46181):
    ...
    value = ws.cell(row=row, column=25).value
    if ranking == 10:
...
drawBoxPlots("Google English sentiment analysis(base on Baidu Translated data)", data_to_plot, ax)
# Save the figure
fig.savefig("GoogleEnglishSentimentAnalysis(baseOnBaiduTranslatedData).png", bbox_inches='tight')
